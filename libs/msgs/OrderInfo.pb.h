...
const Order_DeliveryGate Order_DeliveryGate_DeliveryGate_MAX = Order_DeliveryGate_D3;
...
class Order : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_late_order() const;
  inline void clear_late_order();
  static const int kLateOrderFieldNumber = 20;
  inline bool late_order() const;
  inline void set_late_order(bool value);
 ...
 private:
  ...
  inline void set_has_late_order();
  inline void clear_has_late_order();
...
// optional bool late_order = 20;
inline bool Order::has_late_order() const {
  return (_has_bits_[0] & 0x00000080u) != 0;
}
inline void Order::set_has_late_order() {
  _has_bits_[0] |= 0x00000080u;
}
inline void Order::clear_has_late_order() {
  _has_bits_[0] &= ~0x00000080u;
}
inline void Order::clear_late_order() {
  late_order_ = false;
  clear_has_late_order();
}
inline bool Order::late_order() const {
  return late_order_;
}
inline void Order::set_late_order(bool value) {
  set_has_late_order();
  late_order_ = value;
}
